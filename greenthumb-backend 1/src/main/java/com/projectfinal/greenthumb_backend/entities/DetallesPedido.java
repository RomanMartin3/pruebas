...
public class DetallesPedido {
    ...
    public BigDecimal getPrecioUnitarioAlComprar() {return precioUnitarioAlComprar;}

    public void setPrecioUnitarioAlComprar(BigDecimal precioUnitarioAlComprar) {this.precioUnitarioAlComprar = precioUnitarioAlComprar;}
